...
_G.packer_plugins = {
  ...
  ["solarized.nvim"] = {
    loaded = true,
    path = "/home/abderraouf-belalia/.local/share/nvim/site/pack/packer/start/solarized.nvim",
